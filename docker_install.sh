...
curl -v  --unix-socket /var/run/docker.sock -H 'X-Registry-Auth: { "username": "tapanhalani", "password": "28march1994", "email": "tapanhalani231@gmail.com" }' -X POST http:/images/node-hello-world/push?tag=latest
